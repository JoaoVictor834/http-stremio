...
def get_video_player_url(video_page_url: str) -> str:
...
def get_download_page_url(video_player_url: str) -> str:
    """Get the url of the download page of the given video player url"""
    idna_url = format_video_url(video_player_url)
...
def get_stream_url(download_page_url: str) -> str:
...
def format_video_url(video_player_url: str) -> str:
...
def get_stream_from_video_url(formated_video_url: str) -> str:
